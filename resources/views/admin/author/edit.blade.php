            ...
            <div class="card my-5 w-full lg:w-10/12 xl:w-8/12">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group @if($errors->has('thumbnail')) has-error @endif">
                        ...
                        {!! Form::text('thumbnail', $author->thumbnail, ['class' => 'form-control', 'placeholder' => trans('admin_CRUD.paste_thumbnail_address_here')]) !!}
                    ...
                    <div class="form-group">
                        ...
                        <span class="text-red-500">&nbsp;*&nbsp;</span>
                        {!! Form::select('is_published', [0 => trans('admin_CRUD.save_as_draft'), 1 => trans('admin_CRUD.publish')], isset($author->is_published) ? $author->is_published : null, ['class' => 'form-control']) !!}
                    </div>
