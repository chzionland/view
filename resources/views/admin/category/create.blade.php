        ...
        <div class="col-md-12 flex justify-center">
            ...
            <div class="card my-5 w-full md:w-10/12 lg:w-8/12 xl:w-6/12">
                <div class="card-header">
                    <h2 class="font-bold text-xl ml-10">{{ __('admin_CRUD.create_category') }}</h2>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-group @if($errors->has('name_cn')) has-error @endif">
                        ...
                        {!! Form::text('name_cn', null, ['class' => 'form-control', 'placeholder' => trans('admin_CRUD.input_category_name_in_cn')]) !!}
                    ...
                    <div class="form-group @if($errors->has('name_en')) has-error @endif">
                        ...
                        <span class="text-red-500">*&nbsp;</span>
                        {!! Form::text('name_en', null, ['class' => 'form-control', 'placeholder' => trans('admin_CRUD.input_category_name_in_en')]) !!}
