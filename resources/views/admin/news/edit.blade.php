        ...
        <div class="col-md-12 flex justify-center">
            ...
            <div class="card my-5 w-full xl:w-10/12">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['route' => ['news.update', [$news->id, app()->getLocale()]], 'method'=>'put']) !!}
                    ...
                    <div class="form-group @if($errors->has('title_cn')) has-error @endif">
                        ...
                        {!! Form::text('title_cn', $news->getTranslation('title', 'cn'), [
                            'class' => 'form-control',
                    ...
                    <div class="form-group @if($errors->has('title_en')) has-error @endif">
                        ...
                        <span class="text-red-500">&nbsp;*&nbsp;</span>
                        {!! Form::text('title_en', $news->getTranslation('title', 'en'), [
                            'class' => 'form-control',
                    ...
                    <div class="form-group @if($errors->has('sub_title_cn')) has-error @endif">
                        ...
                        {!! Form::text('sub_title_cn', $news->getTranslation('sub_title', 'cn'), [
                            'class' => 'form-control',
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('is_top', [
                            ...
                            ], isset($news->is_top) ? $news->is_top : null,
                            ['class' => 'form-control']
                        ) !!}
                    </div>
                    ...
                    <div class="form-group @if($errors->has('details_cn')) has-error @endif">
                        ...
                        {!! Form::textarea('details_cn', $news->getTranslation('details', 'cn'), [
                            'class' => 'form-control',
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('is_published', [
                            ...
                            ], isset($news->is_published) ? $news->is_published : null,
                            ['class' => 'form-control']
                        ) !!}
                    </div>
